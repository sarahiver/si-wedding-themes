...
const themeComponents = {
  botanical: {
    ...
    ContactWitnesses: lazy(() => import('../themes/botanical/ContactWitnesses')),
  ...
  editorial: {
    ...
    ContactWitnesses: lazy(() => import('../themes/editorial/ContactWitnesses')),
  ...
  contemporary: {
    ...
    ContactWitnesses: lazy(() => import('../themes/contemporary/ContactWitnesses')),
...
function VideoWeddingPage() {
  ...
  if (isLoading) {
    return (
      <>
        <VideoGlobalStyles />
        <PageWrapper $background="#0a0a0a" style={{ 
          display: 'flex', 
          alignItems: 'center', 
  ...
  return (
    <>
      <VideoGlobalStyles />
      <Suspense fallback={null}>
        <VideoHorizontalScroll sections={sections} background={background} backgroundMobile={backgroundMobile}>
          <components.Hero />
...
function StandardWeddingPage() {
  ...
  // Debug logging
  console.log('🔍 WeddingPage - theme:', themeName);
  console.log('🔍 WeddingPage - component_order from DB:', project?.component_order);
  console.log('🔍 WeddingPage - using componentOrder:', componentOrder);
  ...
  return (
    <>
      ...
      {hasSpecialBackground && themeName === 'botanical' && <BotanicalBackground />}
      ...
      <PageWrapper $background={background}>
        ...
        <main style={hasSpecialBackground ? { position: 'relative', zIndex: 10 } : undefined}>
...
function WeddingPage() {
  ...
  console.log('🚀 WeddingPage LOADED - theme:', theme);
