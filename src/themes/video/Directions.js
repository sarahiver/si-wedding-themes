...
const Grid = styled.div`display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; text-align: left; opacity: 0; animation: ${p => p.$visible ? css`${fadeUp} 0.8s var(--ease-out-expo) forwards` : 'none'}; animation-delay: 0.2s; @media (max-width: 600px) { grid-template-columns: 1fr; }`;
