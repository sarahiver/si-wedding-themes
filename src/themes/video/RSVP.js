...
const Select = styled.select`padding: 1rem; font-family: var(--font-primary); font-size: 0.9rem; color: var(--video-white); background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.15); cursor: pointer; &:focus { outline: none; border-color: var(--video-accent); } option { background: var(--video-charcoal); }`;
const TextArea = styled.textarea`padding: 1rem; font-family: var(--font-primary); font-size: 0.9rem; color: var(--video-white); background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.15); min-height: 80px; resize: vertical; &:focus { outline: none; border-color: var(--video-accent); } &::placeholder { color: var(--video-gray); }`;
