// Video Theme - Gallery with S/W to Color on Hover
...
const ImageWrapper = styled.div`
  ...
  animation-delay: ${p => 0.15 + p.$index * 0.05}s;
`;

const Image = styled.div`
  width: 100%;
  height: 100%;
  background: ${p => p.$image ? `url(${p.$image}) center/cover` : 'linear-gradient(135deg, var(--video-dark), var(--video-charcoal))'};
