...
const Eye = styled.p`font-family:var(--font-s);font-size:1.6rem;color:rgba(255,255,255,0.45);text-align:center;margin-bottom:0.5rem;`;
const H2 = styled.h2`font-family:var(--font-d);font-size:clamp(2.2rem,5vw,3.2rem);font-weight:300;color:white;text-align:center;margin-bottom:2rem;`;
const Lbl = styled.p`font-size:0.5rem;letter-spacing:0.2em;text-transform:uppercase;color:rgba(255,255,255,0.4);margin:1.5rem 0 0.3rem;`;
const Inp = styled.input`width:100%;padding:0.9rem 0;border:none;border-bottom:1px solid rgba(255,255,255,0.12);
  background:transparent;color:white;font-family:var(--font-b);font-size:0.85rem;font-weight:300;
  &::placeholder{color:rgba(255,255,255,0.2);}&:focus{outline:none;border-color:rgba(255,255,255,0.35);}`;
const Sel = styled.select`width:100%;padding:0.9rem 0;border:none;border-bottom:1px solid rgba(255,255,255,0.12);
  background:transparent;color:white;font-family:var(--font-b);font-size:0.85rem;
  &:focus{outline:none;border-color:rgba(255,255,255,0.35);}option{background:#333;color:white;}`;
const Txt = styled.textarea`width:100%;padding:0.9rem 0;border:none;border-bottom:1px solid rgba(255,255,255,0.12);
  background:transparent;color:white;font-family:var(--font-b);font-size:0.85rem;min-height:70px;resize:vertical;
  &::placeholder{color:rgba(255,255,255,0.2);}&:focus{outline:none;border-color:rgba(255,255,255,0.35);}`;
const TogRow = styled.div`display:flex;gap:1rem;margin-top:1rem;`;
const Tog = styled.button`flex:1;padding:0.85rem;border:1px solid ${p=>p.$a?'rgba(255,255,255,0.5)':'rgba(255,255,255,0.1)'};
  background:${p=>p.$a?'rgba(255,255,255,0.1)':'transparent'};color:${p=>p.$a?'white':'rgba(255,255,255,0.35)'};
...
const Btn = styled.button`width:100%;padding:1.1rem;background:transparent;
  ...
  font-family:var(--font-b);font-size:0.6rem;letter-spacing:0.25em;text-transform:uppercase;
  margin-top:2.5rem;cursor:pointer;transition:all 0.4s;
  &:hover{border-color:rgba(255,255,255,0.6);color:white;}&:disabled{opacity:0.3;}`;
const Err = styled.p`font-size:0.75rem;color:#e88;text-align:center;margin-top:1rem;`;
const SuccT = styled.h3`font-family:var(--font-d);font-size:2.5rem;font-weight:300;color:white;text-align:center;margin-bottom:1rem;`;
const SuccP = styled.p`font-size:0.85rem;color:rgba(255,255,255,0.5);text-align:center;`;
