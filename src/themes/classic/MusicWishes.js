...
const Outer = styled.section`padding:0 clamp(2rem,5vw,5rem);background:var(--c-white);position:relative;z-index:2;`;
const S = styled.div`max-width:var(--content-w,1200px);margin:0 auto;
  display:grid;grid-template-columns:1fr 1fr;min-height:70vh;overflow:hidden;
...
function MusicWishes(){
  ...
  return(
    <Outer id="musicwishes" data-theme-light>
      <S>
