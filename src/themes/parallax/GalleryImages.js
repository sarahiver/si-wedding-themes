...
// Uses gallery images (positions 4-10) — all website images come from gallery uploads
...
export default function GalleryImages({ content }) {
  ...
  // Gallery zone uses images starting at position 4
  const imgs = Array.from({ length: 7 }, (_, i) => getGalleryUrl(content, 4 + i))
