...
export const LS_TXT    = [1.5, 0.4]   // "Unsere Geschichte" + CTA
export const CD_TXT    = [3.5, 0.4]   // Countdown + CTA
export const GAL_TXT   = [4.8, 0.3]   // "Galerie" + CTA
export const FOOTER    = [7.5, 0.5]   // Credits/Footer

// ── IMAGE zones (Three.js canvas) ──
export const HERO_IMG  = [0.5, 1.0]   // Hero images
export const LS_IMG    = [1.9, 1.6]   // Love story images
export const CD_IMG    = [3.9, 0.9]   // Countdown image
