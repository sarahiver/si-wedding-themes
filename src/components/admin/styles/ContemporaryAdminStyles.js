...
export const LoginLogo = styled.div`
  text-align: center;
  margin-bottom: 2rem;
  h1 { font-size: 2rem; font-weight: 700; text-transform: uppercase; span { color: #FF6B6B; } }
  p { font-size: 0.8rem; color: #737373; margin-top: 0.5rem; }
`;
...
export const BackLink = styled.a`display: block; text-align: center; margin-top: 1.5rem; font-size: 0.8rem; color: #737373; cursor: pointer; &:hover { color: #FF6B6B; }`;
...
export const SidebarSub = styled.p`font-size: 0.7rem; letter-spacing: 0.15em; text-transform: uppercase; color: #737373; margin-top: 0.25rem;`;
export const NavSection = styled.div`margin-bottom: 0.5rem;`;
export const NavSectionTitle = styled.div`padding: 1rem 1.5rem 0.5rem; font-size: 0.65rem; font-weight: 700; letter-spacing: 0.2em; text-transform: uppercase; color: #A3A3A3;`;
...
export const Main = styled.main`flex: 1; margin-left: 280px; padding: 2rem; @media (max-width: 968px) { margin-left: 0; padding: 1.5rem; padding-top: 4.5rem; }`;
...
export const Label = styled.label`display: block; font-size: 0.7rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: #525252; margin-bottom: 0.5rem;`;
...
export const HelpText = styled.span`font-size: 0.8rem; color: #737373; margin-top: 0.25rem; display: block;`;
...
export const EntryContent = styled.p`font-size: 0.9rem; color: #525252; line-height: 1.5; margin: 0;`;
export const EntryMeta = styled.div`font-size: 0.75rem; color: #A3A3A3; margin-top: 0.5rem;`;
...
export const PhotoCount = styled.span`color: #737373; font-size: 0.85rem;`;
...
// STATUS
export const StatusDescription = styled.div`font-size: 0.95rem; color: #525252; margin-bottom: 1.5rem; line-height: 1.7; p { margin: 0.5rem 0; } strong { color: #0D0D0D; }`;
...
export const InfoLabel = styled.span`font-size: 0.7rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: #737373;`;
